...
const blockoCurrency = CurrencySkin(
  id: 'gem',
...
/// Blocko's gem economy (GAME_IDEAS.md §4.6): `winReward = 3 + floor(score/200)`.
final EconomyConfig blockoEconomy = EconomyConfig(
  currency: blockoCurrency,
  baseWinReward: 3,
  winReward: (result) => result.score ~/ 200,
